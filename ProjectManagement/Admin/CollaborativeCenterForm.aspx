                            ...
                            <div class="modal-body">
                                <div class="row">
                                   ...
                                   <div class="col-xs-1 col-md-2">
                                       <b>CC ID: <asp:Label ID="lblCCId" runat="server"></asp:Label></b>
                                   </div>
                                </div>
                                <br />
                                <div class="row form-group-md">
                                    <div class="col-sm-4 text-left"><label class="control-label" for="txtCCName">Collaborative Center name:</label></div>
                                    <div class="col-sm-6">
                                ...
                                <br />
                                <div class="row form-group-md">
                                    <div class="col-sm-3 text-left"><label class="control-label" for="txtStartDate">Collaboration start:</label></div>
                                    <div class="col-sm-3">
                                ...
                                <br />
                                <div class="row form-group-md">
                                    <div class="col-sm-1 text-left"><label class="control-label" for="txtName">Name:</label></div>
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="txtName" id="txtName" runat="Server" />
                                    </div>
                                    <div class="col-sm-1 text-left"><label class="control-label" for="txtPhone">Phone:</label></div>
                                    <div class="col-sm-4">
                                ...
                                <br />
                                 <div class="row form-group-md">
                                    <div class="col-sm-1 text-left"><label class="control-label" for="txtEmail">Email:</label></div>
                                    <div class="col-sm-5">
                                ...
                                <br />
                                <div class="row form-group-md">
                                    <div class="col-sm-1 text-left"><label class="control-label" for="txtFiscalName">Name:</label></div>
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="txtFiscalName" id="txtFiscalName" runat="Server" />
                                    </div>
                                    <div class="col-sm-1 text-left"><label class="control-label" for="txtFiscalPhone">Phone:</label></div>
                                    <div class="col-sm-4">
                                ...
                                <br />
                                <div class="row form-group-md">
                                    <div class="col-sm-1 text-left"><label class="control-label" for="txtFiscalEmail">Email:</label></div>
                                    <div class="col-sm-5">
                                ...
                                <br />
                                <div class="row form-group-md">
                                    <div class="col-sm-2 text-left"><label class="control-label" for="txtFiscalMail1">Mail address 1:</label></div>
                                    <div class="col-sm-4">
                                        <input class="form-control" type="text" name="txtFiscalMail1" id="txtFiscalMail1" runat="Server" />
                                    </div>
                                    <div class="col-sm-3 text-right"><label class="control-label" for="txtFiscalMail2">Mail address 2 (Apt/Ste#):</label></div>
                                    <div class="col-sm-3">
                                ...
                                <br />
                                <div class="row form-group-md">
                                    <div class="col-sm-1 text-left"><label class="control-label" for="txtFiscalCity">City:</label></div>
                                    <div class="col-sm-3">
                                        <input class="form-control" type="text" name="txtFiscalCity" id="txtFiscalCity" runat="Server" />
                                    </div>
                                    <div class="col-sm-1 text-left"><label class="control-label" for="txtFiscalState">State:</label></div>
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-2 text-right"><label class="control-label" for="txtFiscalZip">Zip code:</label></div>
                                    <div class="col-sm-2">
                                ...
                                <div class="row form-group-md">
                                    <div class="col-sm-2 text-left">
                                        <label class="control-label" for="ddlBillingSchedule">Billing schedule:</label></div>
                                    <div class="col-sm-3">
