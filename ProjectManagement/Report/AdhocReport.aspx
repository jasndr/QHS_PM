            ...
            <div class="panel-body">
                ...
                <div id="divProject">
                    ...
                    <div class="row">
                        ...
                        <div id="divPilotGrant" class="col-md-3">
                            Pilot Grant:                                   
                ...
                <div id="divPaper">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row" style="margin-left: 33px;">
                                <asp:CheckBox ID="chkCOBREid" runat="server" class="checkbox-inline" Text="COBRE-Infectious Diseases"></asp:CheckBox>
                                <asp:CheckBox ID="chkOlaHawaii" runat="server" class="checkbox-inline" Text="OLA Hawaii"></asp:CheckBox>
                                <asp:CheckBox ID="chkP30UHCC" runat="server" class="checkbox-inline" Text="P30 UHCC"></asp:CheckBox>
                            </div>
                        </div>
                        <div class="col-md-2">
                            Has PMCID:
