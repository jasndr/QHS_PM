        ...
        <div class="container body-content">
            ...
            <div class="col-sm-10">
                ...
                <p class="help-block">(only enter numbers)</p>
                    ...
                    <div class="col-sm-2">
                        <input class="form-control" type="text" name="txtPhone" id="txtPhone" placeholder="Phone" runat="server" />
                    </div>
                </div>
                <br />
                <div class="row form-group-md">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" type="text" name="txtDept" id="txtDept" placeholder="Organization/Department" runat="server" />
                    </div>
