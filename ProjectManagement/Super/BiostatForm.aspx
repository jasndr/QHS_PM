<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BiostatForm.aspx.cs" Inherits="ProjectManagement.Admin.Biostat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function pageLoad(sender, args) {
            $('#li_admin').addClass('selected');
            $('#li_biostatform').addClass('selected');
        }
    </script>
</asp:Content>
